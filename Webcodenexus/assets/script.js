...
function printt() {
   ...
   let secthird =   `<div style="height:800px; width:100%;  padding:30px 60px 0px 60px; text-align: justify;">
                     ...
                     ${user.startDate} for a yearly rent of INR Rs. 10,800/- (<span style="font-weight:600;">Ten Thousand Eight Hundred Only</span>)<br><br><span style="font-weight:600; font-size:18px;">NOW THIS RENT AGREEMENT WITNESS AS UNDER:-</span><br>  
                     1)The Tenant/Lessee shall pay the yearly rent of INR<span style="font-weight:600;"> 10,800/- (Ten Thousand Eight Hundred Only)</span> on before  ${dayWithSuffix} day of every <span style="font-weight:600;">${monthNames[inputDate.getMonth() - 1]}</span> without fail, 
                     ...
                     <ol> <li>The Client has paid the rent of Rs 10,800 in advance.</li> <li>The Client submitted the following: <ol type="i"> <li>Copy of Identity Proof such as Aadhaar Card, Voters ID</li> <li>Signed copy of Service Level Agreement</li>
   ...
   let thirdfourth = `<div style="height:800px; width:100%;  padding:30px 60px 0px 60px; text-align: justify;"><span style="font-weight:600; font-size:18px;">NOW THIS RENT AGREEMENT WITNESS AS UNDER:-</span><br>  
                     1)That the Tenant/Lessee shall pay the yearly rent of INR<span style="font-weight:600;"> 10,800/- (Ten Thousand Eight Hundred Only)</span> on before  ${dayWithSuffix} day of every <span style="font-weight:600;">${monthNames[inputDate.getMonth() - 1]}</span> without fail, 
                     excluding electricity and water charges. If the Lessee is not renewing on the above date, Address can be cancelled or transferred on before  ${dayWithSuffix} ${monthNames[inputDate.getMonth() - 1]} ${inputDate.getFullYear() + 1} .</li>
                     <ol> <li>That, The Client has paid the rent of Rs 10,800 in advance.</li> <li>That, The Client submitted the following: <ol type="i"> <li>Copy of Identity Proof such as Aadhaar Card, Voters ID</li> <li>Signed copy of Service Level Agreement</li>
...
let secondcontenttwo=`<div style="height:400px;  width:100%;  padding:10px 60px 0px 60px; text-align: justify;">
                      ...
                      ${user.startDate} for a yearly rent of INR Rs. 10,800/- (<span style="font-weight:600;">Ten Thousand Eight Hundred Only</span>) </div>`
...
let thirdcontentwo= `<div style="height:400px; width:100%;  padding:10px 60px 0px 60px; text-align: justify;"><span style="font-weight:600; font-size:18px;">NOW THIS RENT AGREEMENT WITNESS AS UNDER:-</span><br>  
                     ...
                     excluding electricity and water charges. If the Lessee is not renewing on the above date, Address can be cancelled or transferred on before  ${dayWithSuffix} ${monthNames[inputDate.getMonth() - 1]} ${inputDate.getFullYear() + 1} .</li>
                     <ol>
                     <li>The Client has paid the rent of Rs 10,800 in advance.</li>
